...
<div class="row">
	<div class="col-sm-6">
		...
		<dl class="dl-horizontal">
		  ...
		  <dt>Date of Birth:</dt>
		  <dd><?php echo date_convert_to_php($employee->date_of_birth, "M d, Y"); ?></dd>
		  <dt>Age:</dt>
	...
	<div class="col-sm-6">
		...
		<dl class="dl-horizontal">
		  ...
		  <dt>Date Hired:</dt>
		  <dd><?php echo date_convert_to_php($employee->date_hired, "M d, Y"); ?></dd>
		  <dt>Date Renew:</dt>
		  <dd><?php echo date_convert_to_php($employee->date_renew, "M d, Y"); ?></dd>
		  <dt>Contract Expiry Date:</dt>
		  <dd><?php echo date_convert_to_php($employee->contract_expiry_date, "M d, Y"); ?></dd>
...
<div class="row">
	...
	<div class="col-sm-4">
		...
		<dl class="dl-horizontal">
		  <dt>NBA Clearance:</dt>
		  <dd><?php echo date_convert_to_php($employee->nbi_clearance_date_submitted, "M d, Y"); ?></dd>
		  <dt>Police Clearance:</dt>
		  <dd><?php echo date_convert_to_php($employee->police_clearance_date_submitted, "M d, Y"); ?></dd>
		  <dt>Barangay Clearance:</dt>
		  <dd><?php echo date_convert_to_php($employee->brgy_clearance_date_submitted, "M d, Y"); ?></dd>
		  <dt>Medical Clearance:</dt>
		  <dd><?php echo date_convert_to_php($employee->medical_clearance_date_submitted, "M d, Y"); ?></dd>
		  <dt>Drug Test Clearance:</dt>
		  <dd><?php echo date_convert_to_php($employee->drugtest_clearance_date_submitted, "M d, Y"); ?></dd>
		  <dt>Date Filed:</dt>
		  <dd><?php echo date_convert_to_php($employee->date_filed_up, "M d, Y"); ?></dd>
