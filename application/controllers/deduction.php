...
class Deduction extends Admin_Controller 
{
	...
	public function index()
	{
		...
		if ($this->input->post('btn_employee_filter') == 'Search') 
		{
		...
		if ($this->input->post('btn_deduction_category_filter') == 'Search') 
		{
		...
		if ($this->input->post('btn_filter') == 'Search') 
		{
